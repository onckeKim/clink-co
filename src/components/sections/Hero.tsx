...
export function Hero() {
  return (
    <section className="px-3 pt-3 sm:px-5">
      <div className="relative mx-auto flex min-h-[560px] max-w-7xl items-end overflow-hidden rounded-3xl bg-ink sm:min-h-[640px]">
        <Image
        ...
        <div className="relative flex w-full flex-col gap-6 p-6 sm:p-12 lg:p-16">
          <motion.p
            ...
            className="text-xs font-semibold uppercase tracking-[0.3em] text-ivory/70"
          >
            The Autumn Edit
          </motion.p>
          <motion.h1
            ...
            className="font-display max-w-2xl text-4xl leading-[1.05] text-ivory sm:text-5xl lg:text-6xl"
          >
          ...
          <motion.p
            ...
            className="max-w-md text-sm text-ivory/75 sm:text-base"
          >
          ...
          >
            ...
            <Link
              href="/our-story"
              className={cn(buttonVariants({ variant: "secondary", size: "lg" }), "border-ivory/40 text-ivory hover:bg-ivory hover:text-ink")}
            >
              Our Story
            </Link>
          </motion.div>
