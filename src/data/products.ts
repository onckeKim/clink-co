 ...
 * `products` table instead — see src/lib/supabase and the README's
 * "How catalogue data will connect to Supabase" section. Prices are in
 * ZAR (South African Rand), rounded to whole Rand per local retail
 * convention.
 */
